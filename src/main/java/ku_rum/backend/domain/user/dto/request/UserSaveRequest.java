...
public record UserSaveRequest(
        ...
        @NotBlank(message = "아이디 입력은 필수입니다. 최소 6자 이상입니다.") @Size(min = 6, max = 15) String loginId,
        ...
        @NotBlank(message = "닉네임 입력은 필수입니다. 최대 8자 이하입니다.") @Size(min = 2, max = 10) String nickname,
