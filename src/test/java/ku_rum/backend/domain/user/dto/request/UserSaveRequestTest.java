...
class UserSaveRequestTest {
    ...
    void blankPassword(String password) {
        UserSaveRequest userSaveRequest = new UserSaveRequest("kmw106933","kmw10693@konkuk.ac.kr", password, "202112322", "컴퓨터공학부", "미미미누", AgreementStatus.AGREED);
    ...
    void invalidUserName(String studentId, boolean flag) {
        UserSaveRequest userSaveRequest = new UserSaveRequest("kmw106933", "kmw10693@konkuk.ac.kr","password123", studentId, "컴퓨터공학부", "미미미누", AgreementStatus.AGREED);
